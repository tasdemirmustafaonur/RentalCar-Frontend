            ...
            (updateCarImageResult) => {
              this.carService.update(carUpdateModel).subscribe(
                ...
                (updateFail) => {
                  ...
                  if (
                    updateFail.error.ValidationErrors &&
                    updateFail.error.ValidationErrors.length > 0
                  ) {
                    for (
                      let i = 0;
                      i < updateFail.error.ValidationErrors.length;
                      i++
                    ) {
                      this.toastrService.error(
                        updateFail.error.ValidationErrors[i].ErrorMessage,
                        'Doğrulama hatası'
                      );
                    }
                  }
